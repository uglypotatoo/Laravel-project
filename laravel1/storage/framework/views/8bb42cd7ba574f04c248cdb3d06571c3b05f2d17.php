            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/login">
                        ...
                        <p><?php echo e(isset($credential) ? $credential : ''); ?></p>
                    </form>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel1\resources\views/oauth/login.blade.php ENDPATH**/ ?>