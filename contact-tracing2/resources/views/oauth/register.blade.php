                ...
                <div class="card-body">
                    <form id="myForm">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="phoneNumber" type="tel" class="form-control" name="phoneNumber" value="{{ old('phoneNumber') }}" autocomplete="phoneNumber" autofocus>
...
@push('scripts')
<script src="/assets/js/oauth/register.js"></script>
@endpush