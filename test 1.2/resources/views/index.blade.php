...
@section('page-content')  
       ...
       <section id="home" class="intro d-flex align-items-center" >
        <div class="container-fluid">
          <div class="row">
            <div class="col-lg-5">
              <img src="/img/combat.png" class="img-fluid" alt="" style="width:800px" >
            </div>
            <div class="col-lg-7 d-flex flex-column justify-content-center" >
              ...
              <h1 class="fw-bolder">CONTACT TRACING SYSTEM </h1>
                      ...
                      <div class="row login-register d-flex flex-row">
                        <div class="p-3 col">
                          <a class="btn btn-lg btn-light " href="{{route('welcome')}}" style="background-color:#2596be; color: white; ">REGISTER</a>
                        </div>
                        <div class="p-3 col">
...
<section id="about" class="about d-flex align-items-center">
  <div class="container">
      <div class="row justify-content-center">
        ...
        <div class="col-lg-6">
          <img src="/img/group.png" class="img-fluid" alt="" style="">
        </div>
